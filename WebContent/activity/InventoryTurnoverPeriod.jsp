...
//	request.setCharacterEncoding("EUC-KR");
	...
	try {
		...
		equity = Integer.parseInt(request.getParameter("equity")); // 자기자본
	...
	<table>
		<tr>
			<td><a href="fixed_ratio.html"><input type="submit"
					value="비유동(고정)비율" class="detail"></a></td>
			<td rowspan="2">
				<h2>
					비유동자산:
					<%=FixedAssets%><br>
					<br>
					자기자본:<%=equity %>	
					<a href="fixed_ratio.html"><input type="button" value="재계산"></a>
					<br>
		...
		<tr>
			<td><a href="fixed_asset_to_long_term_capital.html"><input type="submit"
					value="비유동(고정)장기적합률" class="detail"></a></td>
		</tr>
	</table>
</body>
</html>