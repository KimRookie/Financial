...
<%
	...
	try {
		...
		TotalAssets = Integer.parseInt(request.getParameter("TotalAssets")); // 매출액
		TotalAssets2 = Integer.parseInt(request.getParameter("TotalAssets2")); // 매출액
		result = fin.calROA(NetProfit, TotalAssets, TotalAssets2);
	} catch (Exception e) {
		...
		<tr>
			...
			<td rowspan="4">
				<h2>
					...
					<br><br>
					총자산(당기):<%=TotalAssets2%>
					<a href="ROA.html"><input type="button"	value="재계산"></a>
					<br> <br> 
					총자산순이익률(ROA)는 <%=result%>%입니다.			
				</h2>
			</td>
		<tr>
