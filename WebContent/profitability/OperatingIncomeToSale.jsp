...
<%
	...
	String evaluation;
	try {
		profit = Integer.parseInt(request.getParameter("profit")); // 영업이익
		sales = Integer.parseInt(request.getParameter("sales")); // 매출액
		result = fin.calOperatingIncomeToSale(profit, sales);
	} catch (Exception e) {
		...
		<tr>
			...
			<td rowspan="4">
				<h2>
					...
					<br> <br>
					 매출액:<%=sales%>
					<a href="operating_income_to_sale.html"><input type="button"
						value="재계산"></a>
						 <br> <br> 매출액영업이익률은
					<%=result%>%입니다.			
				</h2>
