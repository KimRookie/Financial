...
<%
	...
	String evaluation;
	try {
		capital = Integer.parseInt(request.getParameter("capital")); // 당기자본
		capital2 = Integer.parseInt(request.getParameter("capital2")); // 전기자본
		result = fin.calCapitalGrowth(capital, capital2);
	} catch (Exception e) {
		...
		<tr>
			...
			<td rowspan="3">
				<h2>
					...
					<%=capital%><br> <br> 전기자본:
					<%=capital2%>
					<a href="capital_growth.html"><input type="button"
						value="재계산"></a> <br> <br> 자기자본증가율은
					<%=result%>%입니다.
				</h2>
			</td>
		</tr>
