...
<%
	...
	String evaluation;
	try {
		NetProfit = Integer.parseInt(request.getParameter("NetProfit")); // 당기자본
		NetProfit2 = Integer.parseInt(request.getParameter("NetProfit2")); // 전기자본
		result = fin.calNetIncomeGrowth(NetProfit, NetProfit2);
	} catch (Exception e) {
	...
	<table>
		<tr>
			...
			<td rowspan="3">
				<h2>
					당기자본:
					<%=NetProfit%><br> <br> 전기자본:
					<%=NetProfit2%>
					<a href="net_income_growth.html"><input type="button"
						value="재계산"></a> <br> <br> 순이익증가율은
					<%=result%>%입니다.
				</h2>
			</td>
		</tr>
